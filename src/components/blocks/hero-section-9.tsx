        ...
        <div>
            ...
            <main>
                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-5xl">Your Ultimate Study Buddy Awaits</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl">Join a community where students can share notes, collaborate on assignments, and get help for their studies. Ace your exams together.</p>

                            <Button
                                asChild
                                size="lg">
                                <Link href="#">
                                    <span className="btn-label">Start Studying Now</span>
                                </Link>
                            </Button>
                        </div>
                    </div>
                        ...
                        <div className="[perspective:1200px] [mask-image:linear-gradient(to_right,black_50%,transparent_100%)] -mr-16 pl-16 lg:-mr-56 lg:pl-56">
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                                    <img
                                        className="rounded-[--radius] z-[2] object-cover relative border dark:hidden"
                                        src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=2880&h=2074"
                                        alt="Students studying together"
                                        width={2880}
                                        height={2074}
                                    />
                                    <img
                                        className="rounded-[--radius] z-[2] object-cover relative hidden border dark:block"
                                        src="https://images.unsplash.com/photo-1517842645767-c639042777db?auto=format&fit=crop&q=80&w=2880&h=2074"
                ...
                <section className="bg-background relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-medium">Trusted by students from top universities.</h2>
                        <div className="mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
                            {/* Reusing logos as abstract representations of university/partner programs */}
                            <img
                                className="h-5 w-fit dark:invert grayscale opacity-60"
                            ...
                            />
                            <img
                                className="h-4 w-fit dark:invert grayscale opacity-60"
                            ...
                            />
                            <img
                                className="h-7 w-fit dark:invert grayscale opacity-60"
                            ...
                            />
                            <img
                                className="h-6 w-fit dark:invert grayscale opacity-60"
